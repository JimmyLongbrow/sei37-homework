...
Work.create! title: 'Working Model', year: '1957/01/01', medium: 'bronze sculpture', style: 'Modernsim', image: 'http://www.tate.org.uk/art/images/work/T/T00/T00390_10.jpg', artist_id: krasner.id
...
Work.create! title: 'City with Animals', year: '1930/01/01', medium: 'oil on wood', style: 'Surrealis/cubism', image: 'http://www.dandy-club.com/wp-content/uploads/2013/01/main.jart2_.jpg',artist_id: ernst.id

Work.create! title: 'Die Versuchung des heiligen Antonius', year: '1946/01/01', medium: 'oil on canvas', style: 'Surrealis/cubism', image: 'https://i0.wp.com/www.guggenheim.org/wp-content/uploads/1914/01/48.1172.280_web.jpg?w=870', artist_id: ernst.id

puts "Created #{Work.count}"
